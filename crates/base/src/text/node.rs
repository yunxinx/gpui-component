...
use gpui::{
    ...
    StyleRefinement, Styled, StyledImage as _, TextStyle, WhiteSpace, Window, div, img,
...
use crate::{
    ...
    text::{
        ...
        MarkdownInlineRenderContext, MarkdownNode, TableActionsFn,
...
fn highlight_for_mark(mark: &TextMark, node_cx: &NodeContext) -> HighlightStyle {
    ...
    fn inline_flow_items(
        ...
        for inline_node in &self.children {
            ...
            for (range, style) in &inline_node.marks {
                ...
                node_highlights.push((inner_range, highlight_for_mark(&resolved, node_cx)));
            }
            highlights = gpui::combine_highlights(highlights, node_highlights).collect();
            offset += text_len;
        }

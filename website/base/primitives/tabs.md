...
The authoritative module is [`components/tabs.rs`](https://github.com/longbridge/gpui-component/blob/main/crates/base/examples/showcase/components/tabs.rs). Native and browser previews compile this same file.
